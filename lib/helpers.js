...
define(
	...
	(function() {
		...
		array.FILTER = {
			DUPLICATES: function(_n,_i,_ns) { return _ns.indexOf(_n) === _i; },
			FALSY: function(_n,_i,_ns) { return !!_n; }
		};
		...
		array.last = function(_array) {
			return _array[(_array.hasOwnProperty("length") ? _array : array(_array)).length-1];
		};
	...
	(function() {
		...
		define.call(string,
			...
			function uncapitalize (_s) {
				return string.join(_s.slice(0, 1).toLowerCase(), _s.slice(1));
			},
